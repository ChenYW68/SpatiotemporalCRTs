...
method_labels <- c(
  "MCMC" = paste0("MCMC~'(Kenya; running time = ", elapsed.mcmc.1, "h)'"),
  "VB"   = paste0("VB~'(Kenya; running time = ", elapsed.vb.1, "h)'")
)
...
ggsave(p, file = "./figure/FigS19_trace_plots_realData_Kenya.pdf", width = 18, height = 18)
