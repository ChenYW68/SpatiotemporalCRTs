...
############################################################
method_labels <- c(
                "MCMC" = paste0("MCMC~'(Both; running time = ", elapsed.mcmc.1, "h)'"),
                "VB"   = paste0("VB~'(Both; running time = ", elapsed.vb.1, "h)'")
              )
...
ggsave(p, file = "./figure/FigS15_trace_plots_realData_both.pdf", width = 18, height = 18)
