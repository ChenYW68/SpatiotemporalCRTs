...
Title.1 <- TeX(" (A) Using Kenya's data only")
ATE.1 <- colSums(JSTVC_Kenya.ATE)

ATE.2 <- True.Kenya[5, ] - True.Kenya[1, ]
...
panel.width <- c(0.7, 0.5, 0.5)

pdf(file = file.path(figure_dir, "FigS17_Ranks_Kenya.pdf"), width = 10, height = 5)
