...
writexl::write_xlsx(as.data.frame(Temp1)[, c(1, 4, 3, 5, 6, 2, 7)], path = "./result/summary/Table_S2.xlsx")
writexl::write_xlsx(as.data.frame(Temp2)[, c(1, 4, 3, 5, 6, 2, 7)], path = "./result/summary/Table_S3.xlsx")

tab <- round(cor(Score_Data[, c(9:16, 23:28)]), 2)
writexl::write_xlsx(as.data.frame(tab), path = "./result/summary/Table_S4.xlsx")
